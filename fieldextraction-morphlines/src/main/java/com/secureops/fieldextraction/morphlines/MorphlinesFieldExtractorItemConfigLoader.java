...
public class MorphlinesFieldExtractorItemConfigLoader implements
     ...
     * well.
     *
     * @param config Java Configuration object
     * @param section Java Configuration object section to load
     * @return a String containing the contents of the morphlines config file
     * @throws ConfigurationException when it can't resolve a proper morphline object
     * @throws IOException when a morphline object in a text file cannot be loaded
     * @throws DecoderException when a morphline object cannot be parsed
     */
